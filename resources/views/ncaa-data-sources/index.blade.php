            ...
            >
                <div class="p-6 text-gray-900 space-y-6">
                    ...
                    <div class="border-t border-gray-100 pt-4">
                        ...
                        <form
                            method="POST"
                            action="{{ route('ncaa-data-sources.store') }}"
                    ...
                    >
                        <div class="flex flex-wrap items-end gap-2">
                            <div class="min-w-0 flex-1 sm:max-w-md">
                                <label for="dataset_display_name_ncaa" class="block text-[10px] font-semibold uppercase tracking-wide text-gray-600">
                                    {{ __('DISPLAY NAME') }}
                                </label>
                                <input
                                    id="dataset_display_name_ncaa"
                                    type="text"
                                    x-model="renameDraft"
                                    autocomplete="off"
                            ...
                            <div class="flex w-full flex-col gap-4 sm:flex-row sm:items-stretch sm:gap-5 lg:gap-6 xl:gap-8">
                                ...
                                <div class="min-w-0 w-full flex-1 rounded-lg border border-gray-200 bg-gray-50/70 p-3 shadow-sm sm:p-4 sm:h-full">
                                    <div class="flex min-w-0 w-full flex-row items-start gap-x-2 sm:gap-x-4 md:gap-x-6 lg:gap-x-8">
                                        @foreach (\App\Support\NcaaRangerTraitsSheetLayout::ncaaProfileFeedUiGroups() as $group)
