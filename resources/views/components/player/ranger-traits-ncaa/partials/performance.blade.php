@php
    ...
    $sum = $rangerSheet['ncaa_perf_summer'] ?? [];
    $sumHeat = $heat['ncaa_perf_summer'] ?? [];
@endphp
    ...
    <div class="min-w-0 shrink-0 overflow-x-auto mt-3">
        <div class="ranger-traits-table-clip">
            ...
            >
                ...
                <tbody class="bg-white text-black">
                    <tr>
                        <th scope="row" class="border border-gray-800 bg-gray-200 px-0.5 py-[0.204rem] font-[700] text-gray-900 sm:px-1 sm:py-[0.396rem]">{{ $sum['year'] ?? '—' }}</th>
                        <x-player.ranger-traits-hs.heat-td :heat="$sumHeat['g'] ?? null" class="border border-gray-800 px-0.5 py-[0.102rem] sm:py-[0.198rem]">{{ $sum['g'] ?? '—' }}</x-player.ranger-traits-hs.heat-td>
                        <x-player.ranger-traits-hs.heat-td :heat="$sumHeat['pa'] ?? null" class="border border-gray-800 px-0.5 py-[0.102rem] sm:py-[0.198rem]">{{ $sum['pa'] ?? '—' }}</x-player.ranger-traits-hs.heat-td>
                        <x-player.ranger-traits-hs.heat-td :heat="$sumHeat['avg'] ?? null" class="border border-gray-800 px-0.5 py-[0.102rem] sm:py-[0.198rem]">{{ $sum['avg'] ?? '—' }}</x-player.ranger-traits-hs.heat-td>
                        <x-player.ranger-traits-hs.heat-td :heat="$sumHeat['obp'] ?? null" class="border border-gray-800 px-0.5 py-[0.102rem] sm:py-[0.198rem]">{{ $sum['obp'] ?? '—' }}</x-player.ranger-traits-hs.heat-td>
                        <x-player.ranger-traits-hs.heat-td :heat="$sumHeat['slg'] ?? null" class="border border-gray-800 px-0.5 py-[0.102rem] sm:py-[0.198rem]">{{ $sum['slg'] ?? '—' }}</x-player.ranger-traits-hs.heat-td>
                        <x-player.ranger-traits-hs.heat-td :heat="$sumHeat['ops'] ?? null" class="border border-gray-800 px-0.5 py-[0.102rem] sm:py-[0.198rem]">{{ $sum['ops'] ?? '—' }}</x-player.ranger-traits-hs.heat-td>
                    </tr>
                </tbody>
            </table>
        </div>
